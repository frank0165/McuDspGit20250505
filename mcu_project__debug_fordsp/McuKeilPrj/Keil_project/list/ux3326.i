# 1 "../../src/driver/UX3326/ux3326.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/driver/UX3326/ux3326.c" 2
# 11 "../../src/driver/UX3326/ux3326.c"
...
# 15 "../../src/driver/UX3326/ux3326.h" 2
...
# 5 "../../src/mcu/i2c_comm\\i2c_comm.h" 2
...
# 12 "../../src/driver/UX3326/ux3326.c" 2
# 1 "../../src/mcu\\mcu_pin_type.h" 1
# 13 "../../src/driver/UX3326/ux3326.c" 2
...
# 16 "../../src/driver/UX3326/ux3326.c" 2
...
# 101 "../../src/driver/UX3326/ux3326.c"
void ux3326_gpio_init()
{
...
# 126 "../../src/driver/UX3326/ux3326.c"
void ux3326_reset()
{
...
# 145 "../../src/driver/UX3326/ux3326.c"
void ux3326_soft_txdsbl_ctrl(uint8_t ctrl_switch)
{
 if(ctrl_switch == 1){
...
# 171 "../../src/driver/UX3326/ux3326.c"
void ux3326_normal_setting()
{
 uint16_t i;
 uint8_t reg_val[2];
...
# 195 "../../src/driver/UX3326/ux3326.c"
void ux3326_source_sink_select(uint8_t ctrl_switch)
{
  uint8_t value[2];
  value[0] = 0x61;
...
# 217 "../../src/driver/UX3326/ux3326.c"
void ux3326_get_temperature(float* temperature)
{
...
# 242 "../../src/driver/UX3326/ux3326.c"
void ux3326_get_voltage(float* vcc)
{
...
# 267 "../../src/driver/UX3326/ux3326.c"
void ux3326_get_ld_ibias(float* ibias)
{
...
# 296 "../../src/driver/UX3326/ux3326.c"
void ux3326_set_ld_ibias(uint16_t ibias){
...
# 322 "../../src/driver/UX3326/ux3326.c"
void ux3326_set_ld_imod(uint16_t imod)
{
...
# 346 "../../src/driver/UX3326/ux3326.c"
void ux3326_get_mpd_ibias(float* mpd_ibias)
{
...
# 370 "../../src/driver/UX3326/ux3326.c"
void ux3326_set_tx_ld_cpa(uint8_t value)
{
...
# 390 "../../src/driver/UX3326/ux3326.c"
void ux3326_set_rx_swing(uint16_t value)
{
...
# 407 "../../src/driver/UX3326/ux3326.c"
void ux3326_set_rx_los_threshold(uint8_t los_th){
...
# 424 "../../src/driver/UX3326/ux3326.c"
void ux3326_set_rx_los_hyst(uint8_t los_hyst){
...
# 448 "../../src/driver/UX3326/ux3326.c"
void ux3326_temperaturel_Sample_Average(float* temperature)
{
    float temp = 0.0;
  float temp_sum = 0.0;
...
# 480 "../../src/driver/UX3326/ux3326.c"
void ux3326_apc_auto_enable_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[10];
...
# 531 "../../src/driver/UX3326/ux3326.c"
void ux3326_apc_target_voltage(float voltage_target)
{
