# 1 "../../thd_dsp_download_release_V0_0/i2c_hardware.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../thd_dsp_download_release_V0_0/i2c_hardware.c" 2
...
# 2 "../../thd_dsp_download_release_V0_0/i2c_hardware.c" 2
...
# 3 "../../thd_dsp_download_release_V0_0/i2c_hardware.c" 2
...
# 10 "../../thd_dsp_download_release_V0_0/i2c_hardware.c" 2
# 1 "../../mcu/i2c_opt_ie\\i2c_opt_ie.h" 1
# 53 "../../mcu/i2c_opt_ie\\i2c_opt_ie.h"
...
# 54 "../../mcu/i2c_opt_ie\\i2c_opt_ie.h" 2
...
# 11 "../../thd_dsp_download_release_V0_0/i2c_hardware.c" 2
...
# 12 "../../thd_dsp_download_release_V0_0/i2c_hardware.c" 2
# 63 "../../thd_dsp_download_release_V0_0/i2c_hardware.c"
void dsp_i2c_write_data(uint32_t reg,uint32_t val)
{
    uint8_t txBuff[12];
...
void dsp_i2c_read_data(uint32_t reg,uint32_t* val)
{
     uint8_t txBuff[12];
    memset(txBuff,0,sizeof(txBuff));
    if(0 == val)
    ...
    master_dsp_fsl_reg_4byte_size_read(0xae, reg, txBuff, 4);
    *val = get_u32(txBuff);
    return;
}

void dsp_i2c_WriteAddrContinue(uint32_t addr, uint8_t *buff, uint32_t len)
{
    uint8_t txBuff[250];
    memset(txBuff,0,sizeof(txBuff));


    if(((sizeof(addr) + len) > sizeof(txBuff)) || 0 == buff)
    {
        return;
    }

    set_u32(txBuff,addr);
    memcpy(&txBuff[4],buff,len);

    master_dsp_fsl_reg_4byte_write(0xAE,
       txBuff, (len + 4));
    return;
}

void dsp_i2c_ReadAddrContinue(uint32_t addr, uint8_t *Buff, uint32_t len)
{
    master_dsp_fsl_reg_4byte_size_read(0xAE,
        addr,
        Buff,
        len);
...
void I2C_RegisterWrite(uint32_t addr, uint32_t val)
{
    uint8_t txBuff[10];
    ...
    master_dsp_fsl_reg_4byte_write(0xAE,
       txBuff, 8);
    return;
# 144 "../../thd_dsp_download_release_V0_0/i2c_hardware.c"
}

void I2C_RegisterRead(uint32_t addr, uint32_t *val)
{
    ...
    master_dsp_fsl_reg_4byte_size_read(0xAE,
        ...
        rxBuff,
        4);
    *val = get_u32(&rxBuff[0]);
    return;
# 179 "../../thd_dsp_download_release_V0_0/i2c_hardware.c"
}

void I2C_WriteAddrContinue(uint32_t addr, uint8_t *buff, uint32_t len)
{
    uint8_t txBuff[250];
    memset(txBuff,0,sizeof(txBuff));
    ...
    master_dsp_fsl_reg_4byte_write(0xAE,
       txBuff, (len + 4));
# 214 "../../thd_dsp_download_release_V0_0/i2c_hardware.c"
}
void I2C_ReadAddrContinue(uint32_t addr, uint8_t *Buff, uint32_t len)
{
    master_dsp_fsl_reg_4byte_size_read(0xAE,
        addr,
        Buff,
    ...
    return;
# 247 "../../thd_dsp_download_release_V0_0/i2c_hardware.c"
}
