# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c" 2
# 36 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
...
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c" 2
# 58 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_i2s_deinit(uint32_t spi_periph)
{
    switch(spi_periph){
...
# 116 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
ErrStatus spi_init(uint32_t spi_periph, spi_parameter_struct* spi_struct)
{
...
# 226 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void i2s_init(uint32_t spi_periph, uint32_t mode, uint32_t standard, uint32_t ckpl)
{
    uint32_t reg = 0U;
...
# 272 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void i2s_psc_config(uint32_t spi_periph, uint32_t audiosample, uint32_t frameformat, uint32_t mckout)
{
...
# 323 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void i2s_enable(uint32_t spi_periph)
{
...
# 393 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_dma_enable(uint32_t spi_periph, uint8_t dma)
{
...
# 412 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_dma_disable(uint32_t spi_periph, uint8_t dma)
{
    if(((uint8_t)0x00U) == dma){
        (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= (uint32_t)(~((uint32_t)((uint32_t)0x01U<<(1))));
...
# 430 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
ErrStatus spi_data_frame_format_config(uint32_t spi_periph, uint16_t frame_format)
{
    if((((((uint32_t)0x40000000U) + 0x00003800U) + 0x0000F800U) == spi_periph)||(((((uint32_t)0x40000000U) + 0x00003800U) + 0x00000400U) == spi_periph)){
...
# 458 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_i2s_data_transmit(uint32_t spi_periph, uint16_t data)
{
    uint32_t byten;
...
# 502 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_bidirectional_transfer_config(uint32_t spi_periph, uint32_t transfer_direction)
{
...
# 520 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_crc_polynomial_set(uint32_t spi_periph, uint16_t crc_poly)
{
...
# 582 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
uint16_t spi_crc_get(uint32_t spi_periph, uint8_t crc)
{
...
# 712 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_fifo_access_size_config(uint32_t spi_periph, uint16_t fifo_access_size)
{
...
# 730 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_transmit_odd_config(uint32_t spi_periph, uint16_t odd)
{
...
# 748 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_receive_odd_config(uint32_t spi_periph, uint16_t odd)
{
...
# 766 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_crc_length_set(uint32_t spi_periph, uint16_t crc_length)
{
...
# 786 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_i2s_interrupt_enable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) |= (uint32_t)interrupt;
}
# 803 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
void spi_i2s_interrupt_disable(uint32_t spi_periph, uint8_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((spi_periph) + 0x00000004U)) &= ~(uint32_t)interrupt;
}
# 823 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
FlagStatus spi_i2s_interrupt_flag_get(uint32_t spi_periph, uint8_t interrupt)
{
...
# 906 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_spi.c"
FlagStatus spi_i2s_flag_get(uint32_t spi_periph, uint32_t flag)
{
