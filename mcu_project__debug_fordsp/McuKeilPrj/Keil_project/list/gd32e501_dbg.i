# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c" 2
# 36 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
...
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c" 2
# 46 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_deinit(void)
{
...
# 73 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_low_power_enable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000004U)) |= dbg_low_power;
}
# 88 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_low_power_disable(uint32_t dbg_low_power)
{
    (*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + 0x00000004U)) &= ~dbg_low_power;
}
# 115 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_periph_enable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + ((uint32_t)(dbg_periph) >> 6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
# 142 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_dbg.c"
void dbg_periph_disable(dbg_periph_enum dbg_periph)
{
    ((*(volatile uint32_t *)(uint32_t)(((uint32_t)0xE0044000U) + ((uint32_t)(dbg_periph) >> 6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(dbg_periph) & 0x1FU))));
}
