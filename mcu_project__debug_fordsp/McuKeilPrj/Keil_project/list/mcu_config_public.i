# 1 "../../src/mcu/mcu_config_public.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/mcu_config_public.c" 2
...
# 2 "../../src/mcu/mcu_config_public.c" 2
...
# 3 "../../src/mcu/mcu_config_public.c" 2
...
# 4 "../../src/mcu/mcu_config_public.c" 2
...
# 5 "../../src/mcu/mcu_config_public.c" 2
# 1 "../../src/mcu/mcu_config_public.h" 1
# 15 "../../src/mcu/mcu_config_public.h"
...
# 16 "../../src/mcu/mcu_config_public.h" 2
...
# 6 "../../src/mcu/mcu_config_public.c" 2
# 33 "../../src/mcu/mcu_config_public.c"
void rcu_config_init(void)
{
...
# 87 "../../src/mcu/mcu_config_public.c"
void syscfg_config(void)
{
    syscfg_deinit();
    syscfg_vref_enable();
