# 1 "../../src/ddm_process/ddm_i2c_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/ddm_process/ddm_i2c_interface.c" 2
...
# 5 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
# 6 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
# 7 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
# 8 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
# 9 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
# 17 "../../src/ddm_process/ddm_10g_config\\ddm_10g_config_interface.h"
# 1 "../../src/include\\user_config.h" 1
# 18 "../../src/ddm_process/ddm_10g_config\\ddm_10g_config_interface.h" 2
...
# 15 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
# 16 "../../src/ddm_process/ddm_i2c_interface.h" 2
...
void ddm_i2c_50g_monitor_reg_read(uint8_t regaddr,uint8_t *pbuff,uint32_t
    bufflen);
# 3 "../../src/ddm_process/ddm_i2c_interface.c" 2
# 17 "../../src/ddm_process/ddm_i2c_interface.c"
...
# 72 "../../src/ddm_process/ddm_i2c_interface.c"
...
# 125 "../../src/ddm_process/ddm_i2c_interface.c"
void apd_i2c_vcc_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t apd_value;
...
# 187 "../../src/ddm_process/ddm_i2c_interface.c"
void soa_i2c_ild_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t ild_value;
...
# 227 "../../src/ddm_process/ddm_i2c_interface.c"
void vea_i2c_vcc_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t vea_value;
...
# 277 "../../src/ddm_process/ddm_i2c_interface.c"
void ibias_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 343 "../../src/ddm_process/ddm_i2c_interface.c"
void imod_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t imod_value;
...
# 410 "../../src/ddm_process/ddm_i2c_interface.c"
void swing_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 473 "../../src/ddm_process/ddm_i2c_interface.c"
void rx_eq_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t eq_value;
...
# 525 "../../src/ddm_process/ddm_i2c_interface.c"
void cpa_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
 uint16_t cpa_value;
...
# 589 "../../src/ddm_process/ddm_i2c_interface.c"
void tx_deemph_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 641 "../../src/ddm_process/ddm_i2c_interface.c"
void rx_deemph_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 691 "../../src/ddm_process/ddm_i2c_interface.c"
void rx_los_threshold_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 759 "../../src/ddm_process/ddm_i2c_interface.c"
void rx_los_hyst_i2c_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t *ptr = pbuff + 1;
...
# 820 "../../src/ddm_process/ddm_i2c_interface.c"
void cmd_command_map_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint32_t type = 0;
...
# 926 "../../src/ddm_process/ddm_i2c_interface.c"
void ddm_i2c_switch_auto_process_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 uint8_t reg = 0;
...
# 974 "../../src/ddm_process/ddm_i2c_interface.c"
}
# 992 "../../src/ddm_process/ddm_i2c_interface.c"
void import_binary_file_data_to_mcu_flash(uint8_t *p_buff, uint32_t buff_len) {
    uint32_t write_len;
    ErrStatus ret;
...
# 1062 "../../src/ddm_process/ddm_i2c_interface.c"
