# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c" 2
# 36 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
...
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c" 2
...
# 175 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_discontinuous_mode_config(uint8_t channel_group, uint8_t length)
{
...
# 206 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_special_function_config(uint32_t function, ControlStatus newvalue)
{
    if(newvalue){
...
# 246 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_data_alignment_config(uint32_t data_alignment)
{
...
# 267 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_channel_length_config(uint8_t channel_group, uint32_t length)
{
    switch(channel_group){
    case ((uint8_t)0x01U):
...
# 304 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_regular_channel_config(uint8_t rank, uint8_t channel, uint32_t sample_time)
{
    uint32_t rsq,sampt;
...
# 362 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_inserted_channel_config(uint8_t rank, uint8_t channel, uint32_t sample_time)
{
...
# 402 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_inserted_channel_offset_config(uint8_t inserted_channel, uint16_t offset)
{
    uint8_t inserted_length;
    uint32_t num = 0U;
...
# 440 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_external_trigger_config(uint8_t channel_group, ControlStatus newvalue)
{
    if(newvalue){
...
# 496 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_external_trigger_source_config(uint8_t channel_group, uint32_t external_trigger_source)
{
    switch(channel_group){
    case ((uint8_t)0x01U):
...
# 523 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
...
# 559 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
uint16_t adc_inserted_data_read(uint8_t inserted_channel)
{
    uint32_t idata;
...
# 591 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_watchdog_single_channel_enable(uint8_t channel)
{
...
# 609 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_watchdog_group_channel_enable(uint8_t channel_group)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x04U)) &= (uint32_t)~(((uint32_t)((uint32_t)0x01U<<(23))) | ((uint32_t)((uint32_t)0x01U<<(22))) | ((uint32_t)((uint32_t)0x01U<<(9))));
...
# 647 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_watchdog_threshold_config(uint16_t low_threshold, uint16_t high_threshold)
{
...
# 664 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_resolution_config(uint32_t resolution)
{
...
# 700 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_oversample_mode_config(uint8_t mode, uint16_t shift, uint8_t ratio)
{
...
# 748 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
FlagStatus adc_flag_get(uint32_t flag)
{
...
# 770 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_flag_clear(uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x00U)) &= ~((uint32_t)flag);
}
# 785 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_interrupt_enable(uint32_t interrupt)
{
...
# 813 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_interrupt_disable(uint32_t interrupt)
{
...
# 841 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
FlagStatus adc_interrupt_flag_get(uint32_t flag)
{
...
# 882 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_adc.c"
void adc_interrupt_flag_clear(uint32_t flag)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x00002400U) + 0x00U)) &= ~((uint32_t)flag);
}
