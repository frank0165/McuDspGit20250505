# 1 "../../src/driver/GN7153/gn7153.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/driver/GN7153/gn7153.c" 2
# 11 "../../src/driver/GN7153/gn7153.c"
# 1 "../../src/include\\user_config.h" 1
# 12 "../../src/driver/GN7153/gn7153.c" 2
# 1 "../../src/mcu\\mcu_pin_type.h" 1
# 16 "../../src/mcu\\mcu_pin_type.h"
...
# 17 "../../src/mcu\\mcu_pin_type.h" 2
# 13 "../../src/driver/GN7153/gn7153.c" 2
...
# 14 "../../src/driver/GN7153/gn7153.c" 2
...
# 17 "../../src/driver/GN7153/gn7153.h" 2
...
# 18 "../../src/driver/GN7153/gn7153.h" 2
...
# 15 "../../src/driver/GN7153/gn7153.c" 2
# 1 "../../src/include\\dev_reg_address.h" 1
# 16 "../../src/driver/GN7153/gn7153.c" 2
...
# 19 "../../src/driver/GN7153/gn7153.c" 2
# 33 "../../src/driver/GN7153/gn7153.c"
void gn7153_init()
{
...
# 116 "../../src/driver/GN7153/gn7153.c"
void gn7153_soft_txdsbl_ctrl(uint8_t ctrl_switch)
{
 if(ctrl_switch == 1){
...
# 142 "../../src/driver/GN7153/gn7153.c"
void gn7153_normal_setting()
{
...
# 230 "../../src/driver/GN7153/gn7153.c"
void gn7153_adc()
{
    uint8_t value[2];
...
# 264 "../../src/driver/GN7153/gn7153.c"
void gn7153_source_sink_select(uint8_t ctrl_switch)
{
  uint8_t value[2];
  value[0] = 0x61;
...
# 286 "../../src/driver/GN7153/gn7153.c"
void gn7153_apc_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 value[0] = 0x0B;
...
# 309 "../../src/driver/GN7153/gn7153.c"
void gn7153_override_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 value[0] = 0x0E;
...
# 331 "../../src/driver/GN7153/gn7153.c"
void gn7153_temperature_monitor_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 value[0] = 0x15;
...
# 356 "../../src/driver/GN7153/gn7153.c"
void gn7153_get_temperature(float* temperature)
{
...
# 408 "../../src/driver/GN7153/gn7153.c"
void gn7153_voltage_monitor_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 value[0] = 0x15;
...
# 427 "../../src/driver/GN7153/gn7153.c"
void gn7153_get_voltage(float* vcc)
{
 uint8_t adc_out_lo[1];
 uint8_t adc_out_hi[1];
...
# 471 "../../src/driver/GN7153/gn7153.c"
void gn7153_ld_ibias_monitor_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 uint8_t bias_mon[2];
...
# 499 "../../src/driver/GN7153/gn7153.c"
void gn7153_get_ld_ibias(float* ibias)
{
 uint8_t adc_out_lo[1];
 uint8_t adc_out_hi[1];
...
# 536 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_ld_ibias(uint16_t ibias){
...
# 560 "../../src/driver/GN7153/gn7153.c"
void gn7153_mpd_ibias_monitor_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[2];
 value[0] = 0x15;
...
# 583 "../../src/driver/GN7153/gn7153.c"
void gn7153_get_mpd_ibias(float* ibias)
{
 uint8_t adc_out_lo[1];
 uint8_t adc_out_hi[1];
...
# 619 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_ld_imod(uint16_t mod_vcc)
{
...
# 643 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_tx_ld_cpa(uint8_t value)
{
...
# 668 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_tx_eq_boost(uint8_t value)
{
...
# 689 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_rx_eq_boost(uint16_t value)
{
...
# 707 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_rx_swing(uint16_t value)
{
...
# 724 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_tx_ld_preemph(uint8_t value)
{
...
# 749 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_rx_drv_preemph(uint16_t value)
{
...
# 771 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_rx_los_threshold(uint8_t los_th){
...
# 789 "../../src/driver/GN7153/gn7153.c"
void gn7153_set_rx_los_hyst(uint8_t los_hyst){
...
# 807 "../../src/driver/GN7153/gn7153.c"
void gn7153_temperaturel_Sample_Average(float* temperature)
{
    float temp = 0.0;
  float temp_sum = 0.0;
...
# 839 "../../src/driver/GN7153/gn7153.c"
void gn7153_apc_auto_enable_ctrl(uint8_t ctrl_switch)
{
 uint8_t value[10];
 uint8_t temp_data = 0;
...
# 929 "../../src/driver/GN7153/gn7153.c"
void gn7153_apc_target_voltage(float voltage_target)
{
 uint8_t value[10];
 uint8_t reg = 0xF;
