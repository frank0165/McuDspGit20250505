# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c" 2
# 36 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
...
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c" 2
...
# 278 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_sigs_input_config(cla_enum cla_periph, cla_sigs_enum sigs, uint32_t input)
{
    if(SIGS0 == sigs){
...
# 296 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_lcu_control_config(cla_enum cla_periph, uint8_t lcuctl_value)
{
...
# 312 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_output_config(cla_enum cla_periph, uint32_t output)
{
...
# 361 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_flip_flop_clockpolarity_config(cla_enum cla_periph, uint32_t polarity)
{
...
# 379 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_flip_flop_clocksource_config(cla_enum cla_periph, uint32_t clock_source)
{
...
# 408 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
FlagStatus cla_flag_get(cla_flag_enum flag)
{
...
# 498 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_flag_clear(cla_flag_enum flag)
{
    switch(flag){
        case CLA_FLAG_CLA0NF:
...
# 569 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_negedge_interrupt_enable(uint32_t clanie)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00018000U)) + 0x00000004U)) |= clanie;
}
# 589 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_negedge_interrupt_disable(uint32_t clanidis)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00018000U)) + 0x00000004U)) &= (~clanidis);
}
# 609 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_posedge_interrupt_enable(uint32_t clapie)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00018000U)) + 0x00000004U)) |= clapie;
}
# 629 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_posedge_interrupt_disable(uint32_t clapidis)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40020000U) + 0x00018000U)) + 0x00000004U)) &= (~clapidis);
}
# 657 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
FlagStatus cla_interrupt_flag_get(cla_interrupt_flag_enum int_flag)
{
...
# 760 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cla.c"
void cla_interrupt_flag_clear(cla_interrupt_flag_enum int_flag)
{
    switch(int_flag){
        case CLA_INT_FLAG_CLA0NF:
