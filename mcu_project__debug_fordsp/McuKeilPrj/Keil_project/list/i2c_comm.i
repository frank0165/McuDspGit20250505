# 1 "../../src/mcu/i2c_comm/i2c_comm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/i2c_comm/i2c_comm.c" 2
...
# 3 "../../src/mcu/i2c_comm/i2c_comm.c" 2
...
# 5 "../../src/mcu/i2c_comm/i2c_comm.c" 2
# 1 "../../src/mcu/i2c_comm/i2c_driver.h" 1
# 30 "../../src/mcu/i2c_comm/i2c_driver.h"
void gpio_slave_i2c_config_init(void);
# 45 "../../src/mcu/i2c_comm/i2c_driver.h"
void gpio_master_i2c_config_init(void);
# 6 "../../src/mcu/i2c_comm/i2c_comm.c" 2
...
# 9 "../../src/mcu/i2c_comm/i2c_comm.c" 2
...
# 10 "../../src/mcu/i2c_comm/i2c_comm.c" 2
...
# 59 "../../src/mcu/i2c_comm/i2c_comm.c"
void i2c_config_init()
{
...
# 91 "../../src/mcu/i2c_comm/i2c_comm.c"
void mcu_register_reg_addr_write_callback(uint8_t reg_addr,
    MCU_REGADDR_WRITE_CALLBACK write_callback)
{
 uint32_t i = 0;
...
# 130 "../../src/mcu/i2c_comm/i2c_comm.c"
void mcu_register_reg_addr_read_callback(uint8_t reg_addr,
   MCU_REGADDR_READ_CALLBACK read_callback)
{
 uint32_t i = 0;
...
# 173 "../../src/mcu/i2c_comm/i2c_comm.c"
void mcu_addr0xspec_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len )
{
...
# 222 "../../src/mcu/i2c_comm/i2c_comm.c"
void mcu_addr0xspec_1byte_reg_byte_read(uint32_t slave_address,uint8_t
    regaddress,uint8_t *p_buff,uint32_t buff_len)
{
...
# 267 "../../src/mcu/i2c_comm/i2c_comm.c"
void mcu_addr0xspec_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_address_info,
  uint8_t *p_buff,
  uint32_t buff_len)
{
