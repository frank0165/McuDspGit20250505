# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c" 2
# 36 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
...
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c" 2
# 53 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_deinit(void)
{
...
# 95 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_periph_clock_enable(rcu_periph_enum periph)
{
...
# 123 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_periph_clock_disable(rcu_periph_enum periph)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(periph)>>6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(periph) & 0x1FU))));
}
# 137 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_periph_clock_sleep_enable(rcu_periph_sleep_enum periph)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(periph)>>6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(periph) & 0x1FU))));
}
# 151 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_periph_clock_sleep_disable(rcu_periph_sleep_enum periph)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(periph)>>6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(periph) & 0x1FU))));
}
# 174 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_periph_reset_enable(rcu_periph_reset_enum periph_reset)
{
...
# 198 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_periph_reset_disable(rcu_periph_reset_enum periph_reset)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(periph_reset)>>6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(periph_reset) & 0x1FU))));
}
...
# 235 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_system_clock_source_config(uint32_t ck_sys)
{
...
# 253 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
uint32_t rcu_system_clock_source_get(void)
{
...
# 266 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_ahb_clock_config(uint32_t ck_ahb)
{
    uint32_t ahbpsc = 0U;
...
# 287 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_apb1_clock_config(uint32_t ck_apb1)
{
    uint32_t apb1psc = 0U;
...
# 308 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_apb2_clock_config(uint32_t ck_apb2)
{
    uint32_t apb2psc = 0U;
...
# 334 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_adc_clock_config(rcu_adc_clock_enum ck_adc)
{
...
# 409 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_ckout_config(uint32_t ckout_src, uint32_t ckout_div)
{
    uint32_t ckout = 0U;
...
# 430 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_pll_config(uint32_t pll_src, uint32_t pll_mul)
{
...
# 447 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_usart_clock_config(uint32_t ck_usart)
{
...
# 465 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_i2c_clock_config(uint32_t i2c_periph, uint32_t ck_i2c)
{
    switch(i2c_periph){
...
# 499 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_rtc_clock_config(uint32_t rtc_clock_source)
{
...
# 514 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_hxtal_prediv_config(uint32_t hxtal_prediv)
{
    uint32_t prediv = 0U;
...
# 534 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_lxtal_drive_capability_config(uint32_t lxtal_dricap)
{
...
# 562 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
FlagStatus rcu_flag_get(rcu_flag_enum flag)
{
...
# 596 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
FlagStatus rcu_interrupt_flag_get(rcu_int_flag_enum int_flag)
{
...
# 619 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_interrupt_flag_clear(rcu_int_flag_clear_enum int_flag_clear)
{
...
# 637 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_interrupt_enable(rcu_int_enum stab_int)
{
...
# 655 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_interrupt_disable(rcu_int_enum stab_int)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(stab_int)>>6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(stab_int) & 0x1FU))));
}
# 673 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
ErrStatus rcu_osci_stab_wait(rcu_osci_type_enum osci)
{
    uint32_t stb_cnt = 0U;
...
# 771 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_osci_on(rcu_osci_type_enum osci)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(osci)>>6)))) |= ((uint32_t)((uint32_t)0x01U<<(((uint32_t)(osci) & 0x1FU))));
}
# 789 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_osci_off(rcu_osci_type_enum osci)
{
    ((*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40020000U) + 0x00001000U) + ((uint32_t)(osci)>>6)))) &= ~((uint32_t)((uint32_t)0x01U<<(((uint32_t)(osci) & 0x1FU))));
}
# 803 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_osci_bypass_mode_enable(rcu_osci_type_enum osci)
{
    uint32_t reg;
    switch(osci){
...
# 838 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_osci_bypass_mode_disable(rcu_osci_type_enum osci)
{
    uint32_t reg;
    switch(osci){
...
# 940 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
void rcu_deepsleep_voltage_set(uint32_t dsvol)
{
...
# 960 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_rcu.c"
uint32_t rcu_clock_freq_get(rcu_clock_freq_enum clock)
{
