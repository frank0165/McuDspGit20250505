# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c" 2
# 36 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
...
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c" 2
...
# 86 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
uint32_t mdio_init(uint32_t phy_size, uint32_t phy_softaddr, uint32_t phy_sel, uint16_t devadd)
{
...
# 114 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_phy_length_config(uint32_t phy_bit)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x0000D800U)) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(1)));
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x0000D800U)) + 0x00000000U)) |= phy_bit;
}
# 128 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_soft_phyadr_set(uint32_t phy_soft)
{
...
# 144 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_framefield_phyadr_config(uint32_t phy_sel)
{
...
# 162 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_framefield_devadd_config(uint16_t type)
{
...
# 187 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_timeout_config(uint16_t timeout)
{
...
# 289 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_data_transmit(uint16_t data)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x0000D800U)) + 0x00000010U)) = (uint32_t)data;
}
# 314 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
FlagStatus mdio_flag_get(uint32_t flag)
{
...
# 336 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_flag_clear(uint32_t flag)
{
    volatile uint32_t reg = 0U;
...
# 379 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_interrupt_enable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x0000D800U)) + 0x0000001CU)) |= interrupt;
}
# 404 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_mdio.c"
void mdio_interrupt_disable(uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)(((((uint32_t)0x40000000U) + 0x0000D800U)) + 0x0000001CU)) &= ~(interrupt);
}
