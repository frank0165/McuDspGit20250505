# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c" 2
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
...
# 38 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c" 2
# 47 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_deinit(void)
{
    (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) = ((uint32_t)0x00000000U);
}
# 79 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_mode_init(uint32_t cmp_periph, operating_mode_enum operating_mode, inverting_input_enum inverting_input, cmp_hysteresis_enum output_hysteresis)
{
...
# 112 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_output_init(uint32_t cmp_periph, cmp_output_enum output_slection, uint32_t output_polarity)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
...
# 145 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_enable(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
...
# 162 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_disable(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
        (*(volatile uint32_t *)(uint32_t)((((uint32_t)0x40010000U) + 0x0000001CU) + 0x00000000U)) &= ~((uint32_t)((uint32_t)0x01U<<(0)));
...
# 223 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
void cmp_lock_enable(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
...
# 242 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_cmp.c"
uint32_t cmp_output_level_get(uint32_t cmp_periph)
{
    if(((uint32_t)0x00000000U) == cmp_periph){
