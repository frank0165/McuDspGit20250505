# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c" 2
# 37 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
...
# 38 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c" 2
# 50 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_deinit(uint32_t timer_periph)
{
    switch(timer_periph){
...
# 134 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_init(uint32_t timer_periph, timer_parameter_struct* initpara)
{
...
# 243 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_counter_alignment(uint32_t timer_periph, uint16_t aligned)
{
...
# 282 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_prescaler_config(uint32_t timer_periph, uint16_t prescaler, uint8_t pscreload)
{
...
# 298 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_repetition_value_config(uint32_t timer_periph, uint16_t repetition)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00000030U)) = (uint32_t)repetition;
}
# 310 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_autoreload_value_config(uint32_t timer_periph, uint32_t autoreload)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0000002CU)) = (uint32_t)autoreload;
}
# 322 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_counter_value_config(uint32_t timer_periph, uint32_t counter)
{
...
# 363 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_single_pulse_mode_config(uint32_t timer_periph, uint32_t spmode)
{
...
# 384 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_update_source_config(uint32_t timer_periph, uint32_t update)
{
...
# 405 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_ocpre_clear_source_config(uint32_t timer_periph, uint8_t ocpreclear)
{
...
# 431 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_dma_enable(uint32_t timer_periph, uint16_t dma)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0000000CU)) |= (uint32_t) dma;
}
# 451 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_dma_disable(uint32_t timer_periph, uint16_t dma)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0000000CU)) &= (~(uint32_t)(dma));
}
# 466 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_dma_request_source_select(uint32_t timer_periph, uint8_t dma_request)
{
...
# 507 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_dma_transfer_config(uint32_t timer_periph, uint32_t dma_baseaddr, uint32_t dma_lenth)
{
...
# 529 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_event_software_generate(uint32_t timer_periph, uint16_t event)
{
...
# 566 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_break_config(uint32_t timer_periph, timer_break_parameter_struct* breakpara)
{
...
# 628 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_primary_output_config(uint32_t timer_periph, ControlStatus newvalue)
{
    if(ENABLE == newvalue){
...
# 644 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_control_shadow_config(uint32_t timer_periph, ControlStatus newvalue)
{
    if(ENABLE == newvalue){
...
# 663 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_control_shadow_update_config(uint32_t timer_periph, uint8_t ccuctl)
{
...
# 710 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_config(uint32_t timer_periph, uint16_t channel, timer_oc_parameter_struct* ocpara)
{
    switch(channel){
...
# 860 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_mode_config(uint32_t timer_periph, uint16_t channel, uint16_t ocmode)
{
    switch(channel){
...
# 901 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_pulse_value_config(uint32_t timer_periph, uint16_t channel, uint32_t pulse)
{
    switch(channel){
...
# 941 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_shadow_config(uint32_t timer_periph, uint16_t channel, uint16_t ocshadow)
{
    switch(channel){
...
# 985 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_fast_config(uint32_t timer_periph, uint16_t channel, uint16_t ocfast)
{
    switch(channel){
...
# 1029 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_clear_config(uint32_t timer_periph, uint16_t channel, uint16_t occlear)
{
    switch(channel){
...
# 1073 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_polarity_config(uint32_t timer_periph, uint16_t channel, uint16_t ocpolarity)
{
    switch(channel){
...
# 1117 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_complementary_output_polarity_config(uint32_t timer_periph, uint16_t channel, uint16_t ocnpolarity)
{
    switch(channel){
...
# 1161 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_output_state_config(uint32_t timer_periph, uint16_t channel, uint32_t state)
{
    switch(channel){
...
# 1204 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_complementary_output_state_config(uint32_t timer_periph, uint16_t channel, uint16_t ocnstate)
{
    switch(channel){
...
# 1259 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_input_capture_config(uint32_t timer_periph,uint16_t channel, timer_ic_parameter_struct* icpara)
{
    switch(channel){
...
# 1364 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_input_capture_prescaler_config(uint32_t timer_periph, uint16_t channel, uint16_t prescaler)
{
    switch(channel){
...
# 1404 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
uint32_t timer_channel_capture_value_register_read(uint32_t timer_periph, uint16_t channel)
{
    uint32_t count_value = 0U;
...
# 1446 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_input_pwm_capture_config(uint32_t timer_periph, uint16_t channel, timer_ic_parameter_struct* icpwm)
{
...
# 1554 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_hall_mode_config(uint32_t timer_periph, uint32_t hallmode)
{
...
# 1580 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_input_trigger_source_select(uint32_t timer_periph, uint32_t intrigger)
{
...
# 1602 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_master_output_trigger_source_select(uint32_t timer_periph, uint32_t outrigger)
{
...
# 1625 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_slave_mode_select(uint32_t timer_periph, uint32_t slavemode)
{
...
# 1642 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_master_slave_mode_config(uint32_t timer_periph, uint32_t masterslave)
{
...
# 1670 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
...
# 1697 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
...
# 1733 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_internal_trigger_as_external_clock_config(uint32_t timer_periph, uint32_t intrigger)
{
...
# 1757 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
...
# 1820 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
...
# 1849 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
...
# 1881 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_channel_remap_config(uint32_t timer_periph, uint32_t remap)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00000050U)) = (uint32_t)remap;
}
# 1897 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_write_chxval_register_config(uint32_t timer_periph, uint16_t ccsel)
{
...
# 1918 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_output_value_selection_config(uint32_t timer_periph, uint16_t outsel)
{
...
# 1945 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_interrupt_enable(uint32_t timer_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0000000CU)) |= (uint32_t) interrupt;
}
# 1966 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_interrupt_disable(uint32_t timer_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x0000000CU)) &= (~(uint32_t)interrupt);
}
# 1987 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
FlagStatus timer_interrupt_flag_get(uint32_t timer_periph, uint32_t interrupt)
{
    uint32_t val;
...
# 2014 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_interrupt_flag_clear(uint32_t timer_periph, uint32_t interrupt)
{
    (*(volatile uint32_t *)(uint32_t)((timer_periph) + 0x00000010U)) = (~(uint32_t)interrupt);
}
# 2039 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
FlagStatus timer_flag_get(uint32_t timer_periph, uint32_t flag)
{
...
# 2068 "../../src/mcu/GDE501_fireware/Firmware/GD32E501_standard_peripheral/Source/gd32e501_timer.c"
void timer_flag_clear(uint32_t timer_periph, uint32_t flag)
{
