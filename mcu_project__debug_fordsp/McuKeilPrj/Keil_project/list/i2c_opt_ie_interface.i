# 1 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c" 2
# 13 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
# 1 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h" 1
# 16 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
...
# 17 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h" 2

# 1 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h" 1
# 54 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
...
typedef enum _MCU_FLASH_CONFIG_VALUE_
{
 ...
 RX_PWR_X2_HIGH_50G = 0x4F,
 RX_PWR_X2_LOW_50G = 0x50,
 RX_PWR_X1_HIGH_50G = 0x51,
 RX_PWR_X1_LOW_50G = 0x52,
 RX_PWR_X0_HIGH_50G = 0x53,
 RX_PWR_X0_LOW_50G = 0x54,
 ...
 RX_PWR_X2_HIGH_10G = 0x5D,
 RX_PWR_X2_LOW_10G = 0x5E,
 RX_PWR_X1_HIGH_10G = 0x5F,
 RX_PWR_X1_LOW_10G = 0x60,
 RX_PWR_X0_HIGH_10G = 0x61,
 RX_PWR_X0_LOW_10G = 0x62,
 ...
 RX_PWR_X2_HIGH_1G = 0x6B,
 RX_PWR_X2_LOW_1G = 0x6C,
 RX_PWR_X1_HIGH_1G = 0x6D,
 RX_PWR_X1_LOW_1G = 0x6E,
 RX_PWR_X0_HIGH_1G = 0x6F,
 RX_PWR_X0_LOW_1G = 0x70,
 TT1_TMP = 0x71,
 TT2_TMP = 0x72,
 TT3_TMP = 0x73,
 TT4_TMP = 0x74,
...
# 55 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h" 2
# 1 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_data_type.h" 1
# 55 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_data_type.h"
...
# 97 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_data_type.h"
...
# 202 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_data_type.h"
...
# 56 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h" 2
# 74 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_i2c_event_irq_handler(uint32_t dev_i2c);
# 88 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_i2c_error_irq_handler(uint32_t dev_i2c);
# 105 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void slave_event_irq_handler(uint32_t dev_i2c);
# 119 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void slave_error_irq_handler(void);
# 134 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void i2c_slave_read_write_handle();
# 150 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len );
# 168 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_address_info,
       uint8_t* p_buffer,
       uint32_t buffer_len );
# 186 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_reg_1byte_size_read(uint32_t slave_address,uint8_t reg,uint8_t *p_buffer,
 uint32_t buffer_len);
# 203 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_reg_2byte_size_read(uint32_t slave_address,uint16_t reg,uint8_t *p_buffer,
 uint32_t buffer_len);
# 223 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void slave_v2_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_slave_info,
       uint8_t* p_buffer,
       uint32_t buffer_len);
# 243 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void slave_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len );
# 259 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void master_i2c_config_init();
# 274 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void slave_i2c_middle_handle(void);
# 289 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void slave_i2c_config_init();
# 305 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void user_check_password_write_reg(uint8_t *p_buff,uint32_t buff_len);
# 319 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void user_optical_pwd_limit_init();
# 333 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
uint8_t user_check_write_reg_flag(uint8_t reg);
# 347 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void get_master_i2c_by_dev_address(uint32_t dev_address,uint32_t *ptr_i2c);
# 363 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void i2c_slave_buffer_info_clear();
# 378 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void i2c_master_info_buffer_clear(I2C_MASTER_BUFF_CFG *ptr_buff);
# 393 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void i2c_slave_func_register_read_callback(uint32_t
 slave_address,I2C_READ_CFG_CALLBACK read_callback);
# 409 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void i2c_slave_func_register_write_callback(uint32_t
   slave_address,I2C_WRITE_CFG_CALLBACK write_callback);
# 425 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie.h"
void i2c_global_param_init();
# 19 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h" 2
# 33 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_i2c_event_irq_handler(uint32_t dev_i2c);
# 47 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_i2c_error_irq_handler(uint32_t dev_i2c);
# 63 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void slave_event_irq_handler(uint32_t dev_i2c);
# 77 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void slave_error_irq_handler(void);
# 95 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len );
# 113 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_address_info,
       uint8_t* p_buffer,
       uint32_t buffer_len );
# 131 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_reg_1byte_size_read(uint32_t slave_address,uint8_t reg,uint8_t *p_buffer,
 uint32_t buffer_len);
# 148 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_reg_2byte_size_read(uint32_t slave_address,uint16_t reg,uint8_t *p_buffer,
 uint32_t buffer_len);
# 168 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void slave_v2_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_slave_info,
       uint8_t* p_buffer,
       uint32_t buffer_len);
# 188 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void slave_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len );
# 204 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void master_i2c_config_init();
# 221 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void slave_i2c_config_init();
# 236 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.h"
void i2c_global_param_init();
# 14 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c" 2
...
# 17 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c" 2
...
# 44 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_i2c_event_irq_handler(uint32_t dev_i2c)
{
 uint8_t data = 0;
...
# 141 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_i2c_error_irq_handler(uint32_t dev_i2c)
{
...
# 219 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void slave_event_irq_handler(uint32_t dev_i2c)
{
 uint8_t data = 0;
 uint32_t tmp = 0;
 ...
 {
# 258 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
...
# 355 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void slave_error_irq_handler(void)
{
...
# 380 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
...
# 443 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len )
{
 ...
 run_us = CYCLE_DELAY_TIME_US;
 cyl = 0;
 while_fun(i2c_flag_get(master_i2c, ((uint32_t)((uint32_t)0x01U<<(15)))),run_us,cyl);
 if(1 == cyl)
 {
  g_i2c_global_vars.g_master_i2c_irq_status_pre = I2C_INT_STPDET_STATUS;
...
# 544 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_address_info,
       uint8_t* p_buffer,
       uint32_t buffer_len )
{
 ...
 run_us = CYCLE_DELAY_TIME_US;
 cyl = 0;
 while_fun(!i2c_flag_get(master_i2c, ((uint32_t)((uint32_t)0x01U<<(6)))),run_us,cyl);
 if(1 == cyl)
 {
  g_i2c_global_vars.g_master_i2c_irq_status_pre = I2C_INT_STPDET_STATUS;
  i2c_disable(master_i2c);
  ...
  return;
    ...
    i2c_master_addressing(master_i2c, p_address_info->slave_address, ((uint32_t)((uint32_t)0x01U<<(10))));
 i2c_transfer_byte_number_config(master_i2c, buffer_len);
...
# 671 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_reg_1byte_size_read(uint32_t slave_address,uint8_t reg,uint8_t *p_buffer,
 uint32_t buffer_len)
{
 I2C_ALL_ADDRESS_INFO address_info;
 ...
 master_reg_byte_read(&address_info,p_buffer,buffer_len);
 return;
}
# 697 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_reg_2byte_size_read(uint32_t slave_address,uint16_t reg,uint8_t *p_buffer,
 uint32_t buffer_len)
{
 I2C_ALL_ADDRESS_INFO address_info;
...
# 727 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void slave_v2_reg_byte_read(I2C_ALL_ADDRESS_INFO *p_slave_info,
       uint8_t* p_buffer,
       uint32_t buffer_len )
{
 ...
 else
 {
  ...
  master_reg_byte_read(p_slave_info,
   p_buffer,1);
...
# 790 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void slave_reg_byte_write(uint32_t slave_addr,
         uint8_t* p_buffer,
         uint32_t buffer_len )
{
...
# 815 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
...
# 852 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void master_i2c_config_init()
{
...
# 874 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void slave_i2c_config_init()
{
 slave_i2c_dev_config(((((uint32_t)0x40000000U) + 0x00005400U)+0x00006C00U),0x83,I2C2_EV_IRQn,I2C2_ER_IRQn);
}
# 891 "../../mcu/GDE501_fireware/i2c_opt_ie/i2c_opt_ie_interface.c"
void i2c_global_param_init()
{
