# 1 "../../src/ddm_process/sff_8472.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/ddm_process/sff_8472.c" 2
# 12 "../../src/ddm_process/sff_8472.c"
...
# 13 "../../src/ddm_process/sff_8472.c" 2
...
# 5 "../../src/mcu\\mcu_global_vars_param.h" 2
...
# 14 "../../src/ddm_process/sff_8472.c" 2
...
# 3 "../../src/ddm_process/sff_8472.h" 2
# 1 "../../src/mcu\\mcu_system_comm.h" 1
# 31 "../../src/mcu\\mcu_system_comm.h"
...
# 32 "../../src/mcu\\mcu_system_comm.h" 2
...
# 4 "../../src/ddm_process/sff_8472.h" 2
...
# 15 "../../src/ddm_process/sff_8472.c" 2
# 1 "../../src/mcu\\mcu_pin_type.h" 1
# 17 "../../src/mcu\\mcu_pin_type.h"
# 1 "../../src/include\\user_config.h" 1
# 18 "../../src/mcu\\mcu_pin_type.h" 2
# 16 "../../src/ddm_process/sff_8472.c" 2
...
# 18 "../../src/ddm_process/sff_8472.c" 2
# 1 "../../src/ddm_process/ddm_50g_config\\ddm_50g_config_interface.h" 1
# 15 "../../src/ddm_process/ddm_50g_config\\ddm_50g_config_interface.h"
# 1 "../../src/mcu/GDE501_fireware\\gd32e501_it.h" 1
# 43 "../../src/mcu/GDE501_fireware\\gd32e501_it.h"
...
# 16 "../../src/ddm_process/ddm_50g_config\\ddm_50g_config_interface.h" 2
...
# 19 "../../src/ddm_process/sff_8472.c" 2
...
# 20 "../../src/ddm_process/sff_8472.c" 2
...
# 21 "../../src/ddm_process/sff_8472.c" 2
# 1 "../../src/thermistor_rth\\thermistor_rth.h" 1
# 37 "../../src/thermistor_rth\\thermistor_rth.h"
void get_tec_therm_temperature(float *temp);
# 51 "../../src/thermistor_rth\\thermistor_rth.h"
void get_case_therm_temperature(float *temp);
# 22 "../../src/ddm_process/sff_8472.c" 2


# 1 "../../src/driver/GN7153\\gn7153.h" 1
# 15 "../../src/driver/GN7153\\gn7153.h"
...
{
# 1647 "../../src/ddm_process/sff_8472.c"
{226, -33.4},
{231, -32.3},
{233, -30.4},
{237, -29.3},
...
# 1718 "../../src/ddm_process/sff_8472.c"
void update_om_temperature()
{
...
# 1760 "../../src/ddm_process/sff_8472.c"
void update_om_voltage()
{
 float vcc = 0.0;
 uint16_t code = 0x0000;
...
# 1798 "../../src/ddm_process/sff_8472.c"
void update_om_bias()
{
 float ibias = 0.0;
 uint16_t code = 0x0000;
...
# 1841 "../../src/ddm_process/sff_8472.c"
void update_om_tx_power()
{
 if(~(a2[0x6E] & (1 << 6))){
...
# 1883 "../../src/ddm_process/sff_8472.c"
void update_om_rx_power()
{
 float rxpower_dBm;
 float rxpower_mW;
...
# 1924 "../../src/ddm_process/sff_8472.c"
float calculate_om_tx_power(uint8_t pon_rate)
{
 float ibias = 0.0;
 float txpower = 0.0;
...
# 1977 "../../src/ddm_process/sff_8472.c"
float calculate_om_rx_power(uint8_t pon_rate)
{
 uint16_t rssi = 0;
 float a;
 ...
 return rxpower_dbm;
# 2136 "../../src/ddm_process/sff_8472.c"
}
# 2150 "../../src/ddm_process/sff_8472.c"
void update_om_diagnose()
{
...
# 2193 "../../src/ddm_process/sff_8472.c"
void update_om_warning()
{
 a2[0x70] = 0x00;
 a2[0x70 + 1] = 0x00;
...
# 2611 "../../src/ddm_process/sff_8472.c"
uint8_t om_default_config_flash_read()
{
 uint32_t addr = 0;
 uint16_t i = 0;
...
# 2660 "../../src/ddm_process/sff_8472.c"
void om_default_config_flash_init()
{
...
# 2794 "../../src/ddm_process/sff_8472.c"
void om_crc32_reset()
{
 crc_deinit();
...
# 2821 "../../src/ddm_process/sff_8472.c"
...
# 2867 "../../src/ddm_process/sff_8472.c"
void ddm_process()
{
...
# 2905 "../../src/ddm_process/sff_8472.c"
void flash_config_init()
{
# 2922 "../../src/ddm_process/sff_8472.c"
...
# 3082 "../../src/ddm_process/sff_8472.c"
...
# 3146 "../../src/ddm_process/sff_8472.c"
void calibration_tx_i_50g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
...
# 3205 "../../src/ddm_process/sff_8472.c"
void calibration_tx_i_10g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 6)
 {
...
# 3264 "../../src/ddm_process/sff_8472.c"
void calibration_tx_i_1g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 6)
 {
...
# 3323 "../../src/ddm_process/sff_8472.c"
void calibration_tx_pwr_50g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 6)
 {
...
# 3383 "../../src/ddm_process/sff_8472.c"
void calibration_tx_pwr_10g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 6)
 {
...
# 3443 "../../src/ddm_process/sff_8472.c"
void calibration_tx_pwr_1g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 6)
 {
...
# 3503 "../../src/ddm_process/sff_8472.c"
void calibration_rx_pwr_50g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
...
# 3577 "../../src/ddm_process/sff_8472.c"
void calibration_rx_pwr_10g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 8)
 {
...
# 3651 "../../src/ddm_process/sff_8472.c"
void calibration_rx_pwr_1g_reg_write(uint8_t *pbuff,uint32_t bufflen)
{
 if(0 == pbuff || bufflen < 8)
 {
...
# 3722 "../../src/ddm_process/sff_8472.c"
void om_default_config_flash_read_50g()
{
...
# 3945 "../../src/ddm_process/sff_8472.c"
void om_default_config_flash_read_10g()
{
...
# 4143 "../../src/ddm_process/sff_8472.c"
void om_default_config_flash_read_1g()
{
...
# 4293 "../../src/ddm_process/sff_8472.c"
short convert_2byte_to_int(uint8_t value_high, uint8_t value_low)
{
