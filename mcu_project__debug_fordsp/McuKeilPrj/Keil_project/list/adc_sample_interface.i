# 1 "../../src/mcu/adc_sample_comm/adc_sample_interface.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 389 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../src/mcu/adc_sample_comm/adc_sample_interface.c" 2
# 13 "../../src/mcu/adc_sample_comm/adc_sample_interface.c"
...
# 14 "../../src/mcu/adc_sample_comm/adc_sample_interface.c" 2

# 1 "../../src/mcu/adc_sample_comm/adc_sample_driver.h" 1
# 34 "../../src/mcu/adc_sample_comm/adc_sample_driver.h"
void adc_sample_gpio_init();
# 16 "../../src/mcu/adc_sample_comm/adc_sample_interface.c" 2
# 29 "../../src/mcu/adc_sample_comm/adc_sample_interface.c"
void adc_sample_init()
{
...
# 53 "../../src/mcu/adc_sample_comm/adc_sample_interface.c"
uint16_t adc_inserted_channel_sample_average(uint8_t rank,uint8_t channel)
{
 uint32_t adc_raw = 0;
 uint32_t adc_avg = 0;
...
# 97 "../../src/mcu/adc_sample_comm/adc_sample_interface.c"
uint16_t adc_dma_channel_sample_average(uint8_t channel)
{
    uint32_t adc_raw = 0;
    uint8_t degree = 3;
